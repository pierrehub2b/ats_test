...
public class DemoDragDrop extends ActionTestScript{
	...
	*/
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "dragdrop", cv(pm(0, "chrome")), null));
		exec(2,new ActionCallscript(this, "subscripts.dragdrop.DragDrop1"));
		exec(4,new ActionCallscript(this, "subscripts.dragdrop.DragDrop2"));
		exec(6,new ActionChannelClose(this, "dragdrop"));
	}
}